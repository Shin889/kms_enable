        ...
        <div class="form-container">
            <form method="post" class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input id="applicant_uid" name="applicant_uid" type="text" required placeholder="Enter applicant UID">
                </div>
                ...
                <div class="form-group full-width">
                    ...
                    <textarea id="promotion_history" name="promotion_history" placeholder="Enter promotion history details..."></textarea>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <form method="post" class="update-form">
                                    ...
                                    <input type="date" name="monitoring_start_date" value="<?= $r['monitoring_start_date'] ?>">
                                    <input name="promotion_history" value="<?= htmlspecialchars($r['promotion_history']) ?>" placeholder="Promotion history">
                                    <input name="remarks" value="<?= htmlspecialchars($r['remarks']) ?>" placeholder="Remarks">
