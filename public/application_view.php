...
// Set page title
$page_title = "Application #" . $appId . " | " . strtoupper($currentUser['role']);

// Start output buffering to capture content
ob_start();
?>

<!-- Your HTML content starts here - NO <!DOCTYPE>, <html>, <head>, <body> tags -->
<div class="container">
    <!-- Header -->
    <div class="header">
...
render_layout($currentUser, $page_title, true, $content);
?>