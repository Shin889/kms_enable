...
if ($user['uid'] !== $view_uid) {
    $page_title = 'Personal Data - ' . display($usr['firstName'] . ' ' . $usr['lastName']);
}
?>
<!doctype html>
<html lang="en">
...
<body>
    <div class="dashboard-layout">
        <?php render_sidebar($user, 'personal_data'); ?>
    ...
    .tab-btn { padding: 10px 20px; background: var(--bg-2); border: 1px solid var(--border); border-radius: 8px; cursor: pointer; transition: all 0.3s ease; }
