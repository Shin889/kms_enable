        ...
        <div class="controls">
            <div class="search-sort-row">
                <div class="search-box">
                    ...
                    <input type="text" class="search-input" placeholder="Search job titles, skills, or descriptions..." id="searchInput">
                </div>
        ...
        <div class="vacancies-container" id="vacanciesContainer">
            ...
            <div class="vacancy-card" 
                ...
                <div class="vacancy-header">
                    <h4><?= htmlspecialchars($v['job_title']) ?></h4>
                ...
                <div class="skills-container">
                    ...
                    <div class="skills-list">
                        <?php 
                        $skills = array_map('trim', explode(',', $v['skills_required']));
